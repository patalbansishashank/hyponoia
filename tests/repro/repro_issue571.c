 ...
 *   https://github.com/patalbansishashank/hyponoia/issues/571
 *
 * ROOT CAUSE (src/pipeline/fqn.c, hyp_project_name_from_path, lines ~341-348):
 *
...
TEST(repro_issue571_cjk_project_name) {
    ...
    char *name = hyp_project_name_from_path(cjk_path);
