 ...
 * hybrid LSP (internal/hyp/lsp/c_lsp.c).
 *
 ...
 *   these can silently fail: hyp_pipeline_find_lsp_resolution
 ...
 *   the source (grep '"lsp_' internal/hyp/lsp/c_lsp.c), with its keying site:
