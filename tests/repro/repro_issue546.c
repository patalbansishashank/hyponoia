 ...
 *   first one returned by hyp_store_find_nodes_by_name) and BFS-traverses only
 ...
 *   Either in hyp_store_find_nodes_by_name / hyp_store_bfs (union traversal
...
TEST(repro_issue546_dts_split_caller_set) {
     ...
     *   hyp_store_find_nodes_by_name).  Only callers whose CALLS edges
