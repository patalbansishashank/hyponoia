 ...
 *   - test_grammar_regression.c : EXTRACTION-level breadth (hyp_extract_file with
 ...
 */
#ifndef HYP_TEST_GRAMMAR_CASES_H
#define HYP_TEST_GRAMMAR_CASES_H
...
typedef struct {
    ...
    HYPLanguage lang;       /* explicit language for extraction-level tests */
...
extern const GrammarCase HYP_GRAMMAR_CASES[];
extern const size_t HYP_GRAMMAR_CASES_COUNT;

#endif /* HYP_TEST_GRAMMAR_CASES_H */
