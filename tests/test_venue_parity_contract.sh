...
FORBIDDEN = [
    ...
    (re.compile(r"SMOKE_DOWNLOAD_URL|SMOKE_UPDATE_FIXTURE_DIR"),
     "fixture-server env is wrapper-owned; pass HYP_SMOKE_ARTIFACT_DIR instead"),
...
ALLOWED_EXTRA = {
    ...
    "release.yml": {"npm", "pip", "pip3", "twine", "python", "make",
                    "./mcp-publisher"},
    "_smoke.yml": {"hyponoia"},  # brew-installed CLI version check
}
...
LOCAL_REQUIRED = [
    ...
    # (C:\hyp\scripts\ci\ensure-defender.ps1).
