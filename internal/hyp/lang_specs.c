 ...
 * `signature` (type annotations) is suppressed in hyp_resolve_func_name so it never doubles. */
 ...
 * def-vs-call distinction happens in hyp_resolve_func_name (returns NULL for a
 ...
 * the HYP_LANG_FSHARP branch in hyp_resolve_func_name. */
...
static const HYPEmbeddedLangSpec vue_embedded_imports[] = {
    {"script_element", "raw_text", HYP_LANG_JAVASCRIPT},
    {NULL, NULL, 0},
};
static const HYPEmbeddedLangSpec svelte_embedded_imports[] = {
    {"script_element", "raw_text", HYP_LANG_JAVASCRIPT},
    {NULL, NULL, 0},
};
static const HYPEmbeddedLangSpec html_embedded_imports[] = {
    {"script_element", "raw_text", HYP_LANG_JAVASCRIPT},
    {NULL, NULL, 0},
};
static const HYPEmbeddedLangSpec astro_embedded_imports[] = {
    ...
    {"frontmatter", "frontmatter_js_block", HYP_LANG_JAVASCRIPT},
    {"script_element", "raw_text", HYP_LANG_JAVASCRIPT},
    {NULL, NULL, 0},
};
 ...
 * gate is in hyp_resolve_func_name (returns NULL for a non-def list). */
 ...
 * hyp_resolve_func_name climbs to the parent for naming. A function application
...
static const HYPLangSpec lang_specs[HYP_LANG_COUNT] = {
    // HYP_LANG_GO
    [HYP_LANG_GO] = {HYP_LANG_GO, go_func_types, go_class_types, go_field_types, go_module_types,
    ...
    // HYP_LANG_PYTHON
    [HYP_LANG_PYTHON] = {HYP_LANG_PYTHON, py_func_types, py_class_types, empty_types,
    ...
    // HYP_LANG_JAVASCRIPT
    [HYP_LANG_JAVASCRIPT] =
        {HYP_LANG_JAVASCRIPT, js_func_types, js_class_types, empty_types, js_module_types,
    ...
    // HYP_LANG_TYPESCRIPT
    [HYP_LANG_TYPESCRIPT] = {HYP_LANG_TYPESCRIPT, ts_func_types, ts_class_types, empty_types,
    ...
    // HYP_LANG_TSX
    [HYP_LANG_TSX] =
        {HYP_LANG_TSX, ts_func_types, ts_class_types, empty_types, js_module_types, js_call_types,
    ...
    // HYP_LANG_RUST
    [HYP_LANG_RUST] = {HYP_LANG_RUST, rust_func_types, rust_class_types, rust_field_types,
    ...
    // HYP_LANG_JAVA
    [HYP_LANG_JAVA] = {HYP_LANG_JAVA, java_func_types, java_class_types, java_field_types,
    ...
    // HYP_LANG_CPP
    [HYP_LANG_CPP] = {HYP_LANG_CPP, cpp_func_types, cpp_class_types, cpp_field_types,
    ...
    // HYP_LANG_CSHARP
    [HYP_LANG_CSHARP] = {HYP_LANG_CSHARP, cs_func_types, cs_class_types, cs_field_types,
    ...
    // HYP_LANG_PHP
    [HYP_LANG_PHP] = {HYP_LANG_PHP, php_func_types, php_class_types, empty_types, php_module_types,
    ...
    // HYP_LANG_LUA
    [HYP_LANG_LUA] = {HYP_LANG_LUA, lua_func_types, empty_types, empty_types, lua_module_types,
    ...
    // HYP_LANG_SCALA
    [HYP_LANG_SCALA] = {HYP_LANG_SCALA, scala_func_types, scala_class_types, empty_types,
    ...
    // HYP_LANG_KOTLIN
    [HYP_LANG_KOTLIN] = {HYP_LANG_KOTLIN, kotlin_func_types, kotlin_class_types, empty_types,
    ...
    // HYP_LANG_RUBY
    [HYP_LANG_RUBY] = {HYP_LANG_RUBY, ruby_func_types, ruby_class_types, empty_types,
    ...
    // HYP_LANG_C
    [HYP_LANG_C] = {HYP_LANG_C, c_func_types, c_class_types, c_field_types, c_module_types,
    ...
    // HYP_LANG_BASH
    [HYP_LANG_BASH] = {HYP_LANG_BASH, bash_func_types, empty_types, empty_types, bash_module_types,
    ...
    // HYP_LANG_ZIG
    [HYP_LANG_ZIG] = {HYP_LANG_ZIG, zig_func_types, zig_class_types, zig_field_types,
    ...
    // HYP_LANG_ELIXIR
    [HYP_LANG_ELIXIR] = {HYP_LANG_ELIXIR, elixir_func_types, empty_types, empty_types,
    ...
    // HYP_LANG_HASKELL
    [HYP_LANG_HASKELL] = {HYP_LANG_HASKELL, haskell_func_types, haskell_class_types, empty_types,
    ...
    // HYP_LANG_OCAML
    [HYP_LANG_OCAML] = {HYP_LANG_OCAML, ocaml_func_types, ocaml_class_types, empty_types,
    ...
    // HYP_LANG_OBJC
    [HYP_LANG_OBJC] = {HYP_LANG_OBJC, objc_func_types, objc_class_types, objc_field_types,
    ...
    // HYP_LANG_SWIFT
    [HYP_LANG_SWIFT] = {HYP_LANG_SWIFT, swift_func_types, swift_class_types, swift_field_types,
    ...
    // HYP_LANG_DART
    [HYP_LANG_DART] = {HYP_LANG_DART, dart_func_types, dart_class_types, dart_field_types,
    ...
    // HYP_LANG_PERL
    [HYP_LANG_PERL] = {HYP_LANG_PERL, perl_func_types, empty_types, empty_types, perl_module_types,
    ...
    // HYP_LANG_GROOVY
    [HYP_LANG_GROOVY] = {HYP_LANG_GROOVY, groovy_func_types, groovy_class_types, empty_types,
    ...
    // HYP_LANG_ERLANG
    [HYP_LANG_ERLANG] = {HYP_LANG_ERLANG, erlang_func_types, erlang_class_types, empty_types,
    ...
    // HYP_LANG_R
    [HYP_LANG_R] = {HYP_LANG_R, r_func_types, empty_types, empty_types, r_module_types,
    ...
    // HYP_LANG_HTML
    [HYP_LANG_HTML] = {HYP_LANG_HTML, empty_types, empty_types, empty_types, html_module_types,
    ...
    // HYP_LANG_CSS
    [HYP_LANG_CSS] = {HYP_LANG_CSS, empty_types, empty_types, empty_types, css_module_types,
    ...
    // HYP_LANG_SCSS
    [HYP_LANG_SCSS] = {HYP_LANG_SCSS, scss_func_types, empty_types, empty_types, scss_module_types,
    ...
    // HYP_LANG_YAML
    [HYP_LANG_YAML] = {HYP_LANG_YAML, empty_types, empty_types, empty_types, yaml_module_types,
    ...
    // HYP_LANG_TOML
    [HYP_LANG_TOML] = {HYP_LANG_TOML, empty_types, toml_class_types, empty_types, toml_module_types,
    ...
    // HYP_LANG_HCL
    [HYP_LANG_HCL] = {HYP_LANG_HCL, empty_types, hcl_class_types, empty_types, hcl_module_types,
    ...
    // HYP_LANG_SQL
    [HYP_LANG_SQL] = {HYP_LANG_SQL, sql_func_types, sql_class_types, sql_field_types,
    ...
    // HYP_LANG_DOCKERFILE
    [HYP_LANG_DOCKERFILE] = {HYP_LANG_DOCKERFILE, empty_types, empty_types, empty_types,
    ...
    // HYP_LANG_CLOJURE
    [HYP_LANG_CLOJURE] = {HYP_LANG_CLOJURE, clojure_func_types, empty_types, empty_types,
    ...
    // HYP_LANG_FSHARP
    [HYP_LANG_FSHARP] = {HYP_LANG_FSHARP, fsharp_func_types, fsharp_class_types, empty_types,
    ...
    // HYP_LANG_JULIA
    [HYP_LANG_JULIA] = {HYP_LANG_JULIA, julia_func_types, julia_class_types, empty_types,
    ...
    // HYP_LANG_VIMSCRIPT
    [HYP_LANG_VIMSCRIPT] = {HYP_LANG_VIMSCRIPT, vim_func_types, empty_types, empty_types,
    ...
    // HYP_LANG_NIX
    [HYP_LANG_NIX] = {HYP_LANG_NIX, nix_func_types, empty_types, empty_types, nix_module_types,
    ...
    // HYP_LANG_COMMONLISP
    [HYP_LANG_COMMONLISP] = {HYP_LANG_COMMONLISP, commonlisp_func_types, empty_types, empty_types,
    ...
    // HYP_LANG_ELM
    [HYP_LANG_ELM] = {HYP_LANG_ELM, elm_func_types, elm_class_types, empty_types, elm_module_types,
    ...
    // HYP_LANG_FORTRAN
    [HYP_LANG_FORTRAN] = {HYP_LANG_FORTRAN, fortran_func_types, fortran_class_types, empty_types,
    ...
    // HYP_LANG_CUDA (reuses C++ node types)
    [HYP_LANG_CUDA] = {HYP_LANG_CUDA, cpp_func_types, cpp_class_types, cpp_field_types,
                       cpp_module_types, cpp_call_types, cpp_import_types, cpp_import_types,
                       cpp_branch_types, cpp_var_types, cpp_assign_types, cpp_throw_types, NULL,
                       empty_types, cpp_env_funcs, NULL, tree_sitter_cuda, NULL},

    // HYP_LANG_COBOL
    [HYP_LANG_COBOL] = {HYP_LANG_COBOL, cobol_func_types, empty_types, empty_types,
    ...
    // HYP_LANG_VERILOG
    [HYP_LANG_VERILOG] = {HYP_LANG_VERILOG, verilog_func_types, verilog_class_types, empty_types,
    ...
    // HYP_LANG_EMACSLISP
    [HYP_LANG_EMACSLISP] = {HYP_LANG_EMACSLISP, elisp_func_types, empty_types, empty_types,
                            elisp_module_types, elisp_call_types, empty_types, empty_types,
                            empty_types, empty_types, empty_types, empty_types, NULL, empty_types,
                            NULL, NULL, tree_sitter_elisp, NULL},

    // HYP_LANG_JSON
    [HYP_LANG_JSON] = {HYP_LANG_JSON, empty_types, empty_types, empty_types, json_module_types,
    ...
    // HYP_LANG_XML
    [HYP_LANG_XML] = {HYP_LANG_XML, empty_types, xml_class_types, empty_types, xml_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_xml, NULL},

    // HYP_LANG_MARKDOWN
    [HYP_LANG_MARKDOWN] = {HYP_LANG_MARKDOWN, empty_types, markdown_class_types, empty_types,
                           markdown_module_types, empty_types, empty_types, empty_types,
                           empty_types, empty_types, empty_types, empty_types, NULL, empty_types,
                           NULL, NULL, tree_sitter_markdown, NULL},

    // HYP_LANG_MAKEFILE
    [HYP_LANG_MAKEFILE] = {HYP_LANG_MAKEFILE, makefile_func_types, empty_types, empty_types,
    ...
    // HYP_LANG_CMAKE
    [HYP_LANG_CMAKE] = {HYP_LANG_CMAKE, cmake_func_types, empty_types, empty_types,
    ...
    // HYP_LANG_PROTOBUF
    [HYP_LANG_PROTOBUF] = {HYP_LANG_PROTOBUF, protobuf_func_types, protobuf_class_types,
    ...
    // HYP_LANG_GRAPHQL
    [HYP_LANG_GRAPHQL] = {HYP_LANG_GRAPHQL, empty_types, graphql_class_types, graphql_field_types,
    ...
    // HYP_LANG_VUE
    [HYP_LANG_VUE] = {HYP_LANG_VUE, empty_types, empty_types, empty_types, vue_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_vue,
                      vue_embedded_imports},

    // HYP_LANG_SVELTE
    [HYP_LANG_SVELTE] = {HYP_LANG_SVELTE, empty_types, empty_types, empty_types,
    ...
    // HYP_LANG_MESON
    [HYP_LANG_MESON] = {HYP_LANG_MESON, meson_func_types, empty_types, empty_types,
    ...
    // HYP_LANG_GLSL (reuses C node types)
    [HYP_LANG_GLSL] = {HYP_LANG_GLSL, c_func_types, c_class_types, c_field_types, c_module_types,
                       c_call_types, c_import_types, empty_types, c_branch_types, c_var_types,
                       c_assign_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_glsl,
                       NULL},

    // HYP_LANG_INI
    [HYP_LANG_INI] = {HYP_LANG_INI, empty_types, ini_class_types, empty_types, ini_module_types,
    ...
    // HYP_LANG_MATLAB
    [HYP_LANG_MATLAB] = {HYP_LANG_MATLAB, matlab_func_types, matlab_class_types, empty_types,
    ...
    // HYP_LANG_LEAN
    [HYP_LANG_LEAN] = {HYP_LANG_LEAN, lean_func_types, lean_class_types, empty_types,
    ...
    // HYP_LANG_FORM
    [HYP_LANG_FORM] = {HYP_LANG_FORM, form_func_types, empty_types, empty_types, form_module_types,
    ...
    // HYP_LANG_MAGMA
    [HYP_LANG_MAGMA] = {HYP_LANG_MAGMA, magma_func_types, empty_types, empty_types,
    ...
    // HYP_LANG_WOLFRAM
    [HYP_LANG_WOLFRAM] = {HYP_LANG_WOLFRAM, wolfram_func_types, empty_types, empty_types,
    ...
    // HYP_LANG_SOLIDITY
    [HYP_LANG_SOLIDITY] = {HYP_LANG_SOLIDITY, solidity_func_types, solidity_class_types,
    ...
    // HYP_LANG_TYPST
    [HYP_LANG_TYPST] = {HYP_LANG_TYPST, typst_func_types, empty_types, empty_types,
    ...
    // HYP_LANG_GDSCRIPT
    [HYP_LANG_GDSCRIPT] = {HYP_LANG_GDSCRIPT, gdscript_func_types, gdscript_class_types,
    ...
    // HYP_LANG_QML
    [HYP_LANG_QML] =
        {HYP_LANG_QML, ts_func_types, qml_class_types, qml_field_types, js_module_types,
    ...
    // HYP_LANG_CFSCRIPT
    [HYP_LANG_CFSCRIPT] =
        {HYP_LANG_CFSCRIPT, cfscript_func_types, empty_types, cfscript_field_types, js_module_types,
    ...
    // HYP_LANG_CFML
    [HYP_LANG_CFML] = {HYP_LANG_CFML, cfml_func_types, empty_types, empty_types, cfml_module_types,
    ...
    // HYP_LANG_GLEAM
    [HYP_LANG_GLEAM] = {HYP_LANG_GLEAM, gleam_func_types, gleam_class_types, gleam_field_types,
    ...
    // HYP_LANG_POWERSHELL
    [HYP_LANG_POWERSHELL] = {HYP_LANG_POWERSHELL, powershell_func_types, powershell_class_types,
    ...
    // HYP_LANG_PASCAL
    [HYP_LANG_PASCAL] = {HYP_LANG_PASCAL, pascal_func_types, pascal_class_types, pascal_field_types,
    ...
    // HYP_LANG_DLANG
    [HYP_LANG_DLANG] = {HYP_LANG_DLANG, d_func_types, d_class_types, d_field_types, d_module_types,
    ...
    // HYP_LANG_SCHEME
    [HYP_LANG_SCHEME] = {HYP_LANG_SCHEME, scheme_func_types, empty_types, empty_types,
    ...
    // HYP_LANG_FENNEL
    [HYP_LANG_FENNEL] = {HYP_LANG_FENNEL, fennel_func_types, empty_types, empty_types,
    ...
    // HYP_LANG_FISH
    [HYP_LANG_FISH] = {HYP_LANG_FISH, fish_func_types, empty_types, empty_types, fish_module_types,
    ...
    // HYP_LANG_AWK
    [HYP_LANG_AWK] = {HYP_LANG_AWK, awk_func_types, empty_types, empty_types, awk_module_types,
    ...
    // HYP_LANG_ZSH
    [HYP_LANG_ZSH] = {HYP_LANG_ZSH, zsh_func_types, empty_types, empty_types, zsh_module_types,
    ...
    // HYP_LANG_TCL
    [HYP_LANG_TCL] = {HYP_LANG_TCL, tcl_func_types, tcl_class_types, empty_types, tcl_module_types,
    ...
    // HYP_LANG_ADA
    [HYP_LANG_ADA] = {HYP_LANG_ADA, ada_func_types, ada_class_types, ada_field_types,
    ...
    // HYP_LANG_AGDA
    [HYP_LANG_AGDA] = {HYP_LANG_AGDA, agda_func_types, agda_class_types, empty_types,
    ...
    // HYP_LANG_RACKET
    [HYP_LANG_RACKET] = {HYP_LANG_RACKET, racket_func_types, racket_class_types, empty_types,
    ...
    // HYP_LANG_ODIN
    [HYP_LANG_ODIN] = {HYP_LANG_ODIN, odin_func_types, odin_class_types, odin_field_types,
    ...
    // HYP_LANG_RESCRIPT
    [HYP_LANG_RESCRIPT] = {HYP_LANG_RESCRIPT, rescript_func_types, rescript_class_types,
    ...
    // HYP_LANG_PURESCRIPT
    [HYP_LANG_PURESCRIPT] = {HYP_LANG_PURESCRIPT, purescript_func_types, purescript_class_types,
    ...
    // HYP_LANG_NICKEL
    [HYP_LANG_NICKEL] = {HYP_LANG_NICKEL, nickel_func_types, empty_types, empty_types,
    ...
    // HYP_LANG_CRYSTAL
    [HYP_LANG_CRYSTAL] = {HYP_LANG_CRYSTAL, crystal_func_types, crystal_class_types,
    ...
    // HYP_LANG_TEAL
    [HYP_LANG_TEAL] = {HYP_LANG_TEAL, teal_func_types, teal_class_types, empty_types,
    ...
    // HYP_LANG_HARE
    [HYP_LANG_HARE] = {HYP_LANG_HARE, hare_func_types, hare_class_types, empty_types,
    ...
    // HYP_LANG_PONY
    [HYP_LANG_PONY] = {HYP_LANG_PONY, pony_func_types, pony_class_types, empty_types,
    ...
    // HYP_LANG_LUAU
    [HYP_LANG_LUAU] = {HYP_LANG_LUAU, luau_func_types, luau_class_types, empty_types,
    ...
    // HYP_LANG_JANET
    [HYP_LANG_JANET] = {HYP_LANG_JANET, empty_types, empty_types, empty_types, janet_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL,
                        tree_sitter_janet_simple, NULL},

    // HYP_LANG_SWAY
    [HYP_LANG_SWAY] = {HYP_LANG_SWAY, sway_func_types, sway_class_types, empty_types,
    ...
    // HYP_LANG_NASM
    [HYP_LANG_NASM] = {HYP_LANG_NASM, nasm_func_types, nasm_class_types, empty_types,
    ...
    // HYP_LANG_ASSEMBLY
    [HYP_LANG_ASSEMBLY] = {HYP_LANG_ASSEMBLY, assembly_func_types, empty_types, empty_types,
    ...
    // HYP_LANG_ASTRO
    [HYP_LANG_ASTRO] = {HYP_LANG_ASTRO, empty_types, empty_types, empty_types, astro_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_astro,
                        astro_embedded_imports},

    // HYP_LANG_BLADE
    [HYP_LANG_BLADE] = {HYP_LANG_BLADE, empty_types, empty_types, empty_types, blade_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_blade,
                        NULL},

    // HYP_LANG_JUST
    [HYP_LANG_JUST] = {HYP_LANG_JUST, just_func_types, empty_types, empty_types, just_module_types,
    ...
    // HYP_LANG_WGSL
    [HYP_LANG_WGSL] = {HYP_LANG_WGSL, wgsl_func_types, wgsl_class_types, empty_types,
    ...
    // HYP_LANG_KDL
    [HYP_LANG_KDL] = {HYP_LANG_KDL, empty_types, empty_types, empty_types, kdl_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_kdl, NULL},

    // HYP_LANG_JSON5
    [HYP_LANG_JSON5] = {HYP_LANG_JSON5, empty_types, empty_types, empty_types, json5_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_json5,
                        NULL},

    // HYP_LANG_JSONNET
    [HYP_LANG_JSONNET] = {HYP_LANG_JSONNET, jsonnet_func_types, empty_types, empty_types,
    ...
    // HYP_LANG_RON
    [HYP_LANG_RON] = {HYP_LANG_RON, empty_types, empty_types, empty_types, ron_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_ron, NULL},

    // HYP_LANG_THRIFT
    [HYP_LANG_THRIFT] = {HYP_LANG_THRIFT, thrift_func_types, thrift_class_types, thrift_field_types,
    ...
    // HYP_LANG_CAPNP
    [HYP_LANG_CAPNP] = {HYP_LANG_CAPNP, capnp_func_types, capnp_class_types, capnp_field_types,
    ...
    // HYP_LANG_PROPERTIES
    [HYP_LANG_PROPERTIES] = {HYP_LANG_PROPERTIES, empty_types, empty_types, empty_types,
    ...
    // HYP_LANG_SSHCONFIG
    [HYP_LANG_SSHCONFIG] = {HYP_LANG_SSHCONFIG, empty_types, empty_types, empty_types,
                            sshconfig_module_types, empty_types, empty_types, empty_types,
                            empty_types, empty_types, empty_types, empty_types, NULL, empty_types,
                            NULL, NULL, tree_sitter_ssh_config, NULL},

    // HYP_LANG_BIBTEX
    [HYP_LANG_BIBTEX] = {HYP_LANG_BIBTEX, empty_types, empty_types, empty_types,
                         bibtex_module_types, bibtex_call_types, empty_types, empty_types,
                         empty_types, empty_types, empty_types, empty_types, NULL, empty_types,
                         NULL, NULL, tree_sitter_bibtex, NULL},

    // HYP_LANG_STARLARK
    [HYP_LANG_STARLARK] = {HYP_LANG_STARLARK, starlark_func_types, empty_types, empty_types,
    ...
    // HYP_LANG_BICEP
    [HYP_LANG_BICEP] = {HYP_LANG_BICEP, bicep_func_types, bicep_class_types, empty_types,
    ...
    // HYP_LANG_CSV
    [HYP_LANG_CSV] = {HYP_LANG_CSV, empty_types, empty_types, empty_types, csv_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_csv, NULL},

    // HYP_LANG_REQUIREMENTS
    [HYP_LANG_REQUIREMENTS] = {HYP_LANG_REQUIREMENTS, empty_types, empty_types, empty_types,
    ...
    // HYP_LANG_HLSL
    [HYP_LANG_HLSL] = {HYP_LANG_HLSL, hlsl_func_types, hlsl_class_types, empty_types,
    ...
    // HYP_LANG_VHDL
    [HYP_LANG_VHDL] = {HYP_LANG_VHDL, vhdl_func_types, vhdl_class_types, empty_types,
    ...
    [HYP_LANG_SYSTEMVERILOG] = {HYP_LANG_SYSTEMVERILOG, systemverilog_func_types,
    ...
    // HYP_LANG_DEVICETREE
    [HYP_LANG_DEVICETREE] = {HYP_LANG_DEVICETREE, empty_types, empty_types, empty_types,
    ...
    [HYP_LANG_LINKERSCRIPT] = {HYP_LANG_LINKERSCRIPT, empty_types, empty_types, empty_types,
                               linkerscript_module_types, linkerscript_call_types, empty_types,
                               empty_types, empty_types, empty_types, empty_types, empty_types,
                               NULL, empty_types, NULL, NULL, tree_sitter_linkerscript, NULL},

    // HYP_LANG_GN
    [HYP_LANG_GN] = {HYP_LANG_GN, empty_types, empty_types, empty_types, gn_module_types,
    ...
    // HYP_LANG_KCONFIG
    [HYP_LANG_KCONFIG] = {HYP_LANG_KCONFIG, empty_types, kconfig_class_types, empty_types,
    ...
    // HYP_LANG_BITBAKE
    [HYP_LANG_BITBAKE] = {HYP_LANG_BITBAKE, bitbake_func_types, empty_types, empty_types,
    ...
    // HYP_LANG_SMALI
    [HYP_LANG_SMALI] = {HYP_LANG_SMALI, smali_func_types, smali_class_types, smali_field_types,
                        smali_module_types, empty_types, smali_import_types, empty_types,
                        empty_types, empty_types, empty_types, empty_types, NULL, empty_types, NULL,
                        NULL, tree_sitter_smali, NULL},

    // HYP_LANG_TABLEGEN
    [HYP_LANG_TABLEGEN] = {HYP_LANG_TABLEGEN, tablegen_func_types, tablegen_class_types,
                           empty_types, tablegen_module_types, empty_types, tablegen_import_types,
                           empty_types, empty_types, empty_types, empty_types, empty_types, NULL,
                           empty_types, NULL, NULL, tree_sitter_tablegen, NULL},

    // HYP_LANG_ISPC
    [HYP_LANG_ISPC] = {HYP_LANG_ISPC, ispc_func_types, ispc_class_types, empty_types,
    ...
    // HYP_LANG_CAIRO
    [HYP_LANG_CAIRO] = {HYP_LANG_CAIRO, cairo_func_types, cairo_class_types, empty_types,
    ...
    // HYP_LANG_MOVE
    [HYP_LANG_MOVE] = {HYP_LANG_MOVE, move_func_types, empty_types, empty_types, move_module_types,
    ...
    // HYP_LANG_SQUIRREL
    [HYP_LANG_SQUIRREL] = {HYP_LANG_SQUIRREL, squirrel_func_types, squirrel_class_types,
    ...
    // HYP_LANG_FUNC
    [HYP_LANG_FUNC] = {HYP_LANG_FUNC, func_func_types, empty_types, empty_types, func_module_types,
    ...
    // HYP_LANG_REGEX
    [HYP_LANG_REGEX] = {HYP_LANG_REGEX, empty_types, empty_types, empty_types, regex_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_regex,
                        NULL},

    // HYP_LANG_JSDOC
    [HYP_LANG_JSDOC] = {HYP_LANG_JSDOC, empty_types, empty_types, empty_types, jsdoc_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_jsdoc,
                        NULL},

    // HYP_LANG_RST
    [HYP_LANG_RST] = {HYP_LANG_RST, empty_types, empty_types, empty_types, rst_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_rst, NULL},

    // HYP_LANG_BEANCOUNT
    [HYP_LANG_BEANCOUNT] = {HYP_LANG_BEANCOUNT, empty_types, empty_types, empty_types,
                            beancount_module_types, empty_types, beancount_import_types,
                            empty_types, empty_types, empty_types, empty_types, empty_types, NULL,
                            empty_types, NULL, NULL, tree_sitter_beancount, NULL},

    // HYP_LANG_MERMAID
    [HYP_LANG_MERMAID] = {HYP_LANG_MERMAID, empty_types, empty_types, empty_types,
                          mermaid_module_types, empty_types, empty_types, empty_types, empty_types,
                          empty_types, empty_types, empty_types, NULL, empty_types, NULL, NULL,
                          tree_sitter_mermaid, NULL},

    // HYP_LANG_PUPPET
    [HYP_LANG_PUPPET] = {HYP_LANG_PUPPET, puppet_func_types, puppet_class_types, empty_types,
    ...
    // HYP_LANG_SMITHY
    [HYP_LANG_SMITHY] = {HYP_LANG_SMITHY, smithy_func_types, smithy_class_types, smithy_field_types,
                         smithy_module_types, empty_types, smithy_import_types, empty_types,
                         empty_types, empty_types, empty_types, empty_types, NULL, empty_types,
                         NULL, NULL, tree_sitter_smithy, NULL},

    // HYP_LANG_WIT
    [HYP_LANG_WIT] = {HYP_LANG_WIT, wit_func_types, wit_class_types, wit_field_types,
                      wit_module_types, empty_types, wit_import_types, empty_types, empty_types,
                      empty_types, empty_types, empty_types, NULL, empty_types, NULL, NULL,
                      tree_sitter_wit, NULL},

    // HYP_LANG_TLAPLUS
    [HYP_LANG_TLAPLUS] = {HYP_LANG_TLAPLUS, tlaplus_func_types, empty_types, empty_types,
    ...
    // HYP_LANG_PKL
    [HYP_LANG_PKL] = {HYP_LANG_PKL, pkl_func_types, pkl_class_types, empty_types, pkl_module_types,
    ...
    // HYP_LANG_GOMOD
    [HYP_LANG_GOMOD] = {HYP_LANG_GOMOD, empty_types, empty_types, empty_types, gomod_module_types,
    ...
    // HYP_LANG_APEX
    [HYP_LANG_APEX] = {HYP_LANG_APEX, apex_func_types, apex_class_types, apex_field_types,
    ...
    // HYP_LANG_SOQL
    [HYP_LANG_SOQL] = {HYP_LANG_SOQL, empty_types, empty_types, empty_types, soql_module_types,
    ...
    // HYP_LANG_SOSL
    [HYP_LANG_SOSL] = {HYP_LANG_SOSL, empty_types, empty_types, empty_types, sosl_module_types,
    ...
    // HYP_LANG_KUSTOMIZE — reuses YAML grammar; semantic extraction via hyp_extract_k8s()
    [HYP_LANG_KUSTOMIZE] = {HYP_LANG_KUSTOMIZE, yaml_var_types, empty_types, empty_types,
                            yaml_module_types, empty_types, empty_types, empty_types, empty_types,
                            empty_types, empty_types, empty_types, NULL, empty_types, NULL, NULL,
                            tree_sitter_yaml, NULL},

    // HYP_LANG_K8S — reuses YAML grammar; semantic extraction via hyp_extract_k8s()
    [HYP_LANG_K8S] = {HYP_LANG_K8S, yaml_var_types, empty_types, empty_types, yaml_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_yaml, NULL},

    // HYP_LANG_PINE — Pine Script (TradingView). kvarenzn/tree-sitter-pine (ISC).
    [HYP_LANG_PINE] = {HYP_LANG_PINE, pine_func_types, pine_class_types, empty_types,
    ...
    // HYP_LANG_MOJO
    [HYP_LANG_MOJO] = {HYP_LANG_MOJO, mojo_func_types, mojo_class_types, empty_types,
    ...
    // HYP_LANG_OBJECTSCRIPT_UDL — InterSystems ObjectScript class (.cls) UDL.
    // intersystems/tree-sitter-objectscript.
    [HYP_LANG_OBJECTSCRIPT_UDL] = {HYP_LANG_OBJECTSCRIPT_UDL, objectscript_udl_func_types,
    ...
    [HYP_LANG_OBJECTSCRIPT_ROUTINE] = {HYP_LANG_OBJECTSCRIPT_ROUTINE,
    ...
    // HYP_LANG_OBJECTSCRIPT_EXPORT — Studio Export XML. No grammar row: the
    // pipeline transcodes Export XML to UDL (iris_export_xml.c) and re-extracts
    // each class as HYP_LANG_OBJECTSCRIPT_UDL, so this language never reaches
    // hyp_lang_spec()/hyp_ts_language() directly. Left as a zero spec.

};

_Static_assert(sizeof(lang_specs) / sizeof(lang_specs[0]) == HYP_LANG_COUNT,
               "lang_specs array size must match HYP_LANG_COUNT");

const HYPLangSpec *hyp_lang_spec(HYPLanguage lang) {
    if (lang < 0 || lang >= HYP_LANG_COUNT) {
        return NULL;
    }
    const HYPLangSpec *spec = &lang_specs[lang];
...
const TSLanguage *hyp_ts_language(HYPLanguage lang) {
    const HYPLangSpec *spec = hyp_lang_spec(lang);
