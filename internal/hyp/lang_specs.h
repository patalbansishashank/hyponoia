#ifndef HYP_LANG_SPECS_H
#define HYP_LANG_SPECS_H

#include "hyp.h"

// HYPEmbeddedLangSpec describes a sub-language embedded inside a host AST.
...
typedef struct {
    ...
    HYPLanguage embedded_language; // grammar used to re-parse the content slice
} HYPEmbeddedLangSpec;

// HYPLangSpec mirrors Go's lang.LanguageSpec with NULL-terminated string arrays.
typedef struct {
    ...
    const HYPEmbeddedLangSpec *embedded_imports;
} HYPLangSpec;
...
// Kept out of HYPLangSpec to avoid -Wmissing-field-initializers across 155
