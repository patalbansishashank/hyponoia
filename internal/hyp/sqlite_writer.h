#ifndef HYP_SQLITE_WRITER_H
#define HYP_SQLITE_WRITER_H
...
// indexes, sqlite_master) is written at finalize. hyp_write_db() above is a
// one-shot wrapper over this API (open -> append all nodes -> finalize) and
// produces byte-identical output.
//
// Usage: w = hyp_writer_open(path);
//        hyp_writer_append_nodes(w, batch, n) x N  (ascending, contiguous ids);
//        hyp_writer_finalize(w, ...);   // consumes + frees w, closes the file.
typedef struct hyp_db_writer hyp_db_writer_t;
