#ifndef HYP_LSP_JAVA_LSP_H
#define HYP_LSP_JAVA_LSP_H
 ...
 *   2. Build a HYPTypeRegistry from this file's HYPDefinitions + Java
 ...
 *   5. Emit HYPResolvedCall entries with confidence ≥ 0.6 (the LSP floor
...
enum {
    HYP_JAVA_IMPORT_TYPE = 0,      /* import com.foo.Bar; — type import */
    HYP_JAVA_IMPORT_STATIC = 1,    /* import static com.foo.Bar.method; */
    HYP_JAVA_IMPORT_ON_DEMAND = 2, /* import com.foo.*; — package on-demand */
    HYP_JAVA_IMPORT_STATIC_OD = 3, /* import static com.foo.Bar.*; */
};
...
typedef struct {
    ...
    /* Import map. Each entry is one of HYP_JAVA_IMPORT_*.
 ...
 * hyp_type_unknown(); never returns NULL. */
 ...
 * scoped_type_identifier, void_type, integral_type, ...) into a HYPType. */
 ...
 * type, or hyp_type_unknown() on miss. */
