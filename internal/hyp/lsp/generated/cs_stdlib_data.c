...
#define REG_EXTENSION(qn_, short_name_, recv_, ret_type_)            \
    do {                                                             \
        ...
        {                                                            \
            ...
            rets[1] = NULL;                                          \
            const char **pnames =                                    \
                (const char **)hyp_arena_alloc(arena, 2 * sizeof(*pnames)); \
            pnames[0] = "this";                                       \
            pnames[1] = NULL;                                        \
            const HYPType **ptypes =                                 \
                (const HYPType **)hyp_arena_alloc(arena, 2 * sizeof(*ptypes)); \
            ptypes[0] = (recv_);                                     \
            ptypes[1] = NULL;                                        \
            rf.signature = hyp_type_func(arena, pnames, ptypes, rets); \
        }                                                            \
        hyp_registry_add_func(reg, rf);                              \
    } while (0)

#define OBJ() hyp_type_named(arena, "System.Object")
#define STR() hyp_type_named(arena, "System.String")
#define INT() hyp_type_named(arena, "System.Int32")
#define LONG_T() hyp_type_named(arena, "System.Int64")
#define BOOL_T() hyp_type_named(arena, "System.Boolean")
#define DBL() hyp_type_named(arena, "System.Double")
#define VOID_T() hyp_type_named(arena, "System.Void")
#define UNK() hyp_type_unknown()
...
void hyp_csharp_stdlib_register(HYPTypeRegistry *reg, HYPArena *arena) {
    ...
    REG_METHOD("System.Object", "GetType", hyp_type_named(arena, "System.Type"));
    ...
    REG_METHOD("System.String", "Split",
               hyp_type_template(arena, "System.Array",
                                 (const HYPType *[]){STR(), NULL}, 1));
    ...
    REG_METHOD("System.String", "ToCharArray",
               hyp_type_template(arena, "System.Array",
                                 (const HYPType *[]){hyp_type_named(arena, "System.Char"), NULL},
                                 1));
    ...
    REG_STATIC("System.Convert", "ToSingle", hyp_type_named(arena, "System.Single"));
    REG_STATIC("System.Convert", "ChangeType", OBJ());

    /* ── System.Guid ───────────────────────────────────────────── */
    REG_TYPE("System.Guid", "Guid", false, valuetype_parent);
    REG_STATIC("System.Guid", "NewGuid", hyp_type_named(arena, "System.Guid"));
    REG_STATIC("System.Guid", "Parse", hyp_type_named(arena, "System.Guid"));
    ...
    REG_STATIC("System.DateTime", "Now", hyp_type_named(arena, "System.DateTime"));
    REG_STATIC("System.DateTime", "UtcNow", hyp_type_named(arena, "System.DateTime"));
    REG_STATIC("System.DateTime", "Today", hyp_type_named(arena, "System.DateTime"));
    REG_STATIC("System.DateTime", "Parse", hyp_type_named(arena, "System.DateTime"));
    REG_STATIC("System.DateTime", "TryParse", BOOL_T());
    REG_METHOD("System.DateTime", "AddDays", hyp_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "AddHours", hyp_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "AddMinutes", hyp_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "AddSeconds", hyp_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "AddMilliseconds", hyp_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "Subtract", hyp_type_named(arena, "System.TimeSpan"));
    REG_METHOD("System.DateTime", "ToString", STR());
    REG_METHOD("System.DateTime", "ToUniversalTime", hyp_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "ToLocalTime", hyp_type_named(arena, "System.DateTime"));
    ...
    REG_STATIC("System.DateTimeOffset", "Now", hyp_type_named(arena, "System.DateTimeOffset"));
    REG_STATIC("System.DateTimeOffset", "UtcNow", hyp_type_named(arena, "System.DateTimeOffset"));
    ...
    REG_STATIC("System.IO.File", "ReadAllBytes",
               hyp_type_template(arena, "System.Array",
                                 (const HYPType *[]){hyp_type_named(arena, "System.Byte"), NULL},
                                 1));
    ...
    REG_STATIC("System.IO.File", "Open", hyp_type_named(arena, "System.IO.FileStream"));
    REG_STATIC("System.IO.File", "OpenRead", hyp_type_named(arena, "System.IO.FileStream"));
    REG_STATIC("System.IO.File", "OpenWrite", hyp_type_named(arena, "System.IO.FileStream"));
    REG_STATIC("System.IO.File", "Create", hyp_type_named(arena, "System.IO.FileStream"));
    REG_STATIC("System.IO.File", "ReadAllTextAsync",
               hyp_type_template(arena, "System.Threading.Tasks.Task",
                                 (const HYPType *[]){STR(), NULL}, 1));
    REG_STATIC("System.IO.File", "WriteAllTextAsync",
               hyp_type_named(arena, "System.Threading.Tasks.Task"));
    ...
    REG_STATIC("System.IO.Directory", "CreateDirectory",
               hyp_type_named(arena, "System.IO.DirectoryInfo"));
    ...
    REG_STATIC("System.IO.Directory", "EnumerateFiles",
               hyp_type_template(arena, "System.Collections.Generic.IEnumerable",
                                 (const HYPType *[]){STR(), NULL}, 1));
    ...
    REG_METHOD("System.Text.StringBuilder", "Append",
               hyp_type_named(arena, "System.Text.StringBuilder"));
    ...
    REG_STATIC("System.Text.Encoding", "UTF8", hyp_type_named(arena, "System.Text.Encoding"));
    REG_STATIC("System.Text.Encoding", "ASCII", hyp_type_named(arena, "System.Text.Encoding"));
    REG_STATIC("System.Text.Encoding", "Unicode", hyp_type_named(arena, "System.Text.Encoding"));
    ...
    REG_STATIC("System.Text.RegularExpressions.Regex", "Match",
               hyp_type_named(arena, "System.Text.RegularExpressions.Match"));
    REG_STATIC("System.Text.RegularExpressions.Regex", "Matches",
               hyp_type_named(arena, "System.Text.RegularExpressions.MatchCollection"));
    ...
    REG_METHOD("System.Collections.Generic.IEnumerable", "GetEnumerator",
               hyp_type_template(arena, "System.Collections.Generic.IEnumerator",
                                 (const HYPType *[]){hyp_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.Collections.Generic.List", "Find", hyp_type_type_param(arena, "T"));
    REG_METHOD("System.Collections.Generic.List", "FindAll",
               hyp_type_template(arena, "System.Collections.Generic.List",
                                 (const HYPType *[]){hyp_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.Collections.Generic.IDictionary", "Keys",
               hyp_type_template(arena, "System.Collections.Generic.ICollection",
                                 (const HYPType *[]){hyp_type_type_param(arena, "TKey"), NULL},
                                 1));
    REG_METHOD("System.Collections.Generic.IDictionary", "Values",
               hyp_type_template(arena, "System.Collections.Generic.ICollection",
                                 (const HYPType *[]){hyp_type_type_param(arena, "TValue"), NULL},
                                 1));
    ...
    REG_METHOD("System.Collections.Generic.Queue", "Dequeue", hyp_type_type_param(arena, "T"));
    REG_METHOD("System.Collections.Generic.Queue", "Peek", hyp_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Collections.Generic.Stack", "Pop", hyp_type_type_param(arena, "T"));
    REG_METHOD("System.Collections.Generic.Stack", "Peek", hyp_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Collections.Generic.KeyValuePair", "Key",
               hyp_type_type_param(arena, "TKey"));
    REG_METHOD("System.Collections.Generic.KeyValuePair", "Value",
               hyp_type_type_param(arena, "TValue"));
    ...
    REG_METHOD("System.Span", "Slice",
               hyp_type_template(arena, "System.Span",
                                 (const HYPType *[]){hyp_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.ReadOnlySpan", "Slice",
               hyp_type_template(arena, "System.ReadOnlySpan",
                                 (const HYPType *[]){hyp_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.Nullable", "Value", hyp_type_type_param(arena, "T"));
    REG_METHOD("System.Nullable", "GetValueOrDefault", hyp_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Threading.Tasks.Task", "Exception",
               hyp_type_named(arena, "System.AggregateException"));
    ...
    REG_METHOD("System.Threading.CancellationTokenSource", "Token",
               hyp_type_named(arena, "System.Threading.CancellationToken"));
    ...
    REG_METHOD("System.Exception", "InnerException",
               hyp_type_named(arena, "System.Exception"));
    ...
    REG_EXTENSION("System.Linq.Enumerable.Where", "Where",
                   hyp_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const HYPType *[]){hyp_type_type_param(arena, "T"), NULL},
                                     1),
                   hyp_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const HYPType *[]){hyp_type_type_param(arena, "T"), NULL},
                                     1));
    ...
    REG_EXTENSION("System.Linq.Enumerable.OrderBy", "OrderBy",
                   hyp_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const HYPType *[]){hyp_type_type_param(arena, "T"), NULL},
                                     1),
                   hyp_type_template(arena, "System.Linq.IOrderedEnumerable",
                                     (const HYPType *[]){hyp_type_type_param(arena, "T"), NULL},
                                     1));
    ...
    REG_EXTENSION("System.Linq.Enumerable.ToDictionary", "ToDictionary",
                   hyp_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const HYPType *[]){hyp_type_type_param(arena, "T"), NULL},
                                     1),
                   hyp_type_template(arena, "System.Collections.Generic.Dictionary",
                                     (const HYPType *[]){UNK(), UNK(), NULL}, 2));
    REG_EXTENSION("System.Linq.Enumerable.ToHashSet", "ToHashSet",
                   hyp_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const HYPType *[]){hyp_type_type_param(arena, "T"), NULL},
                                     1),
                   hyp_type_template(arena, "System.Collections.Generic.HashSet",
                                     (const HYPType *[]){hyp_type_type_param(arena, "T"), NULL},
                                     1));
    ...
    REG_STATIC("System.Text.Json.JsonDocument", "Parse",
               hyp_type_named(arena, "System.Text.Json.JsonDocument"));
    ...
    REG_METHOD("System.Net.Http.HttpResponseMessage", "EnsureSuccessStatusCode",
               hyp_type_named(arena, "System.Net.Http.HttpResponseMessage"));
    ...
    REG_METHOD("System.Net.Http.HttpResponseMessage", "Content",
               hyp_type_named(arena, "System.Net.Http.HttpContent"));
    ...
    REG_METHOD("Microsoft.Extensions.Logging.ILogger", "BeginScope",
               hyp_type_named(arena, "System.IDisposable"));
    ...
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "Ok",
               hyp_type_named(arena, "Microsoft.AspNetCore.Mvc.OkObjectResult"));
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "NotFound",
               hyp_type_named(arena, "Microsoft.AspNetCore.Mvc.NotFoundObjectResult"));
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "BadRequest",
               hyp_type_named(arena, "Microsoft.AspNetCore.Mvc.BadRequestObjectResult"));
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "StatusCode",
               hyp_type_named(arena, "Microsoft.AspNetCore.Mvc.IActionResult"));
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "Json",
               hyp_type_named(arena, "Microsoft.AspNetCore.Mvc.JsonResult"));
    ...
    REG_METHOD("Microsoft.EntityFrameworkCore.DbSet", "Find", hyp_type_type_param(arena, "T"));
    REG_METHOD("Microsoft.EntityFrameworkCore.DbSet", "FindAsync",
               hyp_type_template(arena, "System.Threading.Tasks.ValueTask",
                                 (const HYPType *[]){hyp_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.Lazy", "Value", hyp_type_type_param(arena, "T"));
    ...
    REG_GENERIC_TYPE_P1("System.Func", "Func", false,
                         "System.Delegate", single_t_params);
    REG_METHOD("System.Func", "Invoke", hyp_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Tuple", "Item1", hyp_type_type_param(arena, "T"));
    ...
    REG_STATIC("System.Diagnostics.Stopwatch", "StartNew",
               hyp_type_named(arena, "System.Diagnostics.Stopwatch"));
    ...
    REG_METHOD("System.Diagnostics.Stopwatch", "Elapsed",
               hyp_type_named(arena, "System.TimeSpan"));
