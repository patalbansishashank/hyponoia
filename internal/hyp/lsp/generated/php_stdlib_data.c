...
#define REG_METHOD(class_qn_, method_name_, ret_type_) do {                        \
    ...
    rf.min_params = -1;                                                            \
    rf.qualified_name = hyp_arena_sprintf(arena, "%s.%s", (class_qn_), (method_name_)); \
    rf.short_name = (method_name_);                                                \
    rf.receiver_type = (class_qn_);                                                \
    {                                                                              \
        const HYPType **rets = (const HYPType **)hyp_arena_alloc(arena, 2 * sizeof(*rets)); \
...
void hyp_php_stdlib_register(HYPTypeRegistry *reg, HYPArena *arena) {
    ...
    REG_METHOD("Throwable", "getMessage", hyp_type_builtin(arena, "string"));
    REG_METHOD("Throwable", "getCode", hyp_type_builtin(arena, "int"));
    REG_METHOD("Throwable", "getFile", hyp_type_builtin(arena, "string"));
    REG_METHOD("Throwable", "getLine", hyp_type_builtin(arena, "int"));
    REG_METHOD("Throwable", "getTrace", hyp_type_builtin(arena, "array"));
    REG_METHOD("Throwable", "getTraceAsString", hyp_type_builtin(arena, "string"));
    REG_METHOD("Throwable", "getPrevious", hyp_type_named(arena, "Throwable"));
    ...
    REG_METHOD("DateTimeInterface", "format", hyp_type_builtin(arena, "string"));
    REG_METHOD("DateTimeInterface", "getTimestamp", hyp_type_builtin(arena, "int"));
    REG_METHOD("DateTimeInterface", "getOffset", hyp_type_builtin(arena, "int"));
    REG_METHOD("DateTime", "modify", hyp_type_named(arena, "DateTime"));
    REG_METHOD("DateTime", "add", hyp_type_named(arena, "DateTime"));
    REG_METHOD("DateTime", "sub", hyp_type_named(arena, "DateTime"));
    REG_METHOD("DateTime", "setDate", hyp_type_named(arena, "DateTime"));
    REG_METHOD("DateTime", "setTime", hyp_type_named(arena, "DateTime"));
    REG_METHOD("DateTimeImmutable", "modify", hyp_type_named(arena, "DateTimeImmutable"));
    REG_METHOD("DateTimeImmutable", "add", hyp_type_named(arena, "DateTimeImmutable"));
    REG_METHOD("DateTimeImmutable", "sub", hyp_type_named(arena, "DateTimeImmutable"));
    ...
    REG_METHOD("Iterator", "next", hyp_type_builtin(arena, "void"));
    REG_METHOD("Iterator", "rewind", hyp_type_builtin(arena, "void"));
    REG_METHOD("Iterator", "valid", hyp_type_builtin(arena, "bool"));
    REG_METHOD("Countable", "count", hyp_type_builtin(arena, "int"));
    REG_METHOD("ArrayAccess", "offsetExists", hyp_type_builtin(arena, "bool"));
    REG_METHOD("ArrayAccess", "offsetGet", MIXED);
    REG_METHOD("ArrayAccess", "offsetSet", hyp_type_builtin(arena, "void"));
    REG_METHOD("ArrayAccess", "offsetUnset", hyp_type_builtin(arena, "void"));
    REG_METHOD("Stringable", "__toString", hyp_type_builtin(arena, "string"));
    REG_METHOD("ArrayObject", "getIterator", hyp_type_named(arena, "ArrayIterator"));
    ...
    REG_METHOD("Psr.Log.LoggerInterface", "info", hyp_type_builtin(arena, "void"));
    REG_METHOD("Psr.Log.LoggerInterface", "warning", hyp_type_builtin(arena, "void"));
    REG_METHOD("Psr.Log.LoggerInterface", "error", hyp_type_builtin(arena, "void"));
    REG_METHOD("Psr.Log.LoggerInterface", "debug", hyp_type_builtin(arena, "void"));
    REG_METHOD("Psr.Log.LoggerInterface", "critical", hyp_type_builtin(arena, "void"));
    REG_METHOD("Psr.Log.LoggerInterface", "log", hyp_type_builtin(arena, "void"));
    REG_METHOD("Psr.Container.ContainerInterface", "get", MIXED);
    REG_METHOD("Psr.Container.ContainerInterface", "has", hyp_type_builtin(arena, "bool"));
    REG_METHOD("Psr.Http.Message.RequestInterface", "getMethod", hyp_type_builtin(arena, "string"));
    REG_METHOD("Psr.Http.Message.RequestInterface", "getUri",
               hyp_type_named(arena, "Psr.Http.Message.UriInterface"));
    ...
    REG_METHOD("Closure", "bindTo", hyp_type_named(arena, "Closure"));
    ...
    /* Eloquent Builder chain methods. */
    {
        ...
        const HYPType *self = hyp_type_named(arena, "Illuminate.Database.Eloquent.Builder");
        const HYPType *coll = hyp_type_named(arena, "Illuminate.Database.Eloquent.Collection");
        const HYPType *model = hyp_type_named(arena, "Illuminate.Database.Eloquent.Model");
        ...
        REG_METHOD(eb, "exists", hyp_type_builtin(arena, "bool"));
        REG_METHOD(eb, "count", hyp_type_builtin(arena, "int"));
        REG_METHOD(eb, "sum", hyp_type_builtin(arena, "int"));
        REG_METHOD(eb, "value", MIXED);
        REG_METHOD(eb, "toSql", hyp_type_builtin(arena, "string"));
    }

    /* Eloquent Model: convenience static-call entry points. */
    {
        const char *em = "Illuminate.Database.Eloquent.Model";
        const HYPType *eb = hyp_type_named(arena, "Illuminate.Database.Eloquent.Builder");
        const HYPType *self = hyp_type_named(arena, "Illuminate.Database.Eloquent.Model");
        const HYPType *coll = hyp_type_named(arena, "Illuminate.Database.Eloquent.Collection");
        ...
        REG_METHOD(em, "save", hyp_type_builtin(arena, "bool"));
        REG_METHOD(em, "update", hyp_type_builtin(arena, "bool"));
        REG_METHOD(em, "delete", hyp_type_builtin(arena, "bool"));
        REG_METHOD(em, "fresh", self);
        REG_METHOD(em, "refresh", self);
        REG_METHOD(em, "load", self);
        REG_METHOD(em, "loadMissing", self);
        REG_METHOD(em, "toArray", hyp_type_builtin(arena, "array"));
        REG_METHOD(em, "toJson", hyp_type_builtin(arena, "string"));
    ...
    /* Illuminate\Support\Collection — chain returns self. */
    {
        ...
        const HYPType *self = hyp_type_named(arena, "Illuminate.Support.Collection");
        ...
        REG_METHOD(coll_qn, "count", hyp_type_builtin(arena, "int"));
        REG_METHOD(coll_qn, "isEmpty", hyp_type_builtin(arena, "bool"));
        REG_METHOD(coll_qn, "isNotEmpty", hyp_type_builtin(arena, "bool"));
        REG_METHOD(coll_qn, "contains", hyp_type_builtin(arena, "bool"));
        REG_METHOD(coll_qn, "toArray", hyp_type_builtin(arena, "array"));
        REG_METHOD(coll_qn, "toJson", hyp_type_builtin(arena, "string"));
        REG_METHOD(coll_qn, "implode", hyp_type_builtin(arena, "string"));
        REG_METHOD(coll_qn, "sum", hyp_type_builtin(arena, "int"));
        REG_METHOD(coll_qn, "avg", hyp_type_builtin(arena, "float"));
    ...
    REG_TYPE("Carbon.CarbonImmutable", "CarbonImmutable", false, carbon_parents);
    {
        ...
        const HYPType *self = hyp_type_named(arena, "Carbon.Carbon");
        ...
        REG_METHOD(c, "format", hyp_type_builtin(arena, "string"));
        REG_METHOD(c, "toDateString", hyp_type_builtin(arena, "string"));
        REG_METHOD(c, "toDateTimeString", hyp_type_builtin(arena, "string"));
        REG_METHOD(c, "diffInDays", hyp_type_builtin(arena, "int"));
        REG_METHOD(c, "diffInHours", hyp_type_builtin(arena, "int"));
        REG_METHOD(c, "diffInMinutes", hyp_type_builtin(arena, "int"));
    ...
    REG_METHOD("Psr.Http.Message.RequestInterface", "withMethod",
               hyp_type_named(arena, "Psr.Http.Message.RequestInterface"));
    REG_METHOD("Psr.Http.Message.RequestInterface", "withUri",
               hyp_type_named(arena, "Psr.Http.Message.RequestInterface"));
    REG_METHOD("Psr.Http.Message.ResponseInterface", "withStatus",
               hyp_type_named(arena, "Psr.Http.Message.ResponseInterface"));
    ...
    REG_METHOD("Doctrine.ORM.EntityManagerInterface", "persist", hyp_type_builtin(arena, "void"));
    REG_METHOD("Doctrine.ORM.EntityManagerInterface", "remove", hyp_type_builtin(arena, "void"));
    REG_METHOD("Doctrine.ORM.EntityManagerInterface", "flush", hyp_type_builtin(arena, "void"));
    REG_METHOD("Doctrine.ORM.EntityManagerInterface", "createQuery",
               hyp_type_named(arena, "Doctrine.ORM.Query"));
    REG_METHOD("Doctrine.ORM.EntityManagerInterface", "createQueryBuilder",
               hyp_type_named(arena, "Doctrine.ORM.QueryBuilder"));
    REG_METHOD("Doctrine.ORM.EntityManagerInterface", "getRepository",
               hyp_type_named(arena, "Doctrine.ORM.EntityRepository"));
    {
        const char *qb = "Doctrine.ORM.QueryBuilder";
        const HYPType *self = hyp_type_named(arena, "Doctrine.ORM.QueryBuilder");
        ...
        REG_METHOD(qb, "getQuery", hyp_type_named(arena, "Doctrine.ORM.Query"));
    }
    REG_METHOD("Doctrine.ORM.Query", "getResult", hyp_type_builtin(arena, "array"));
    REG_METHOD("Doctrine.ORM.Query", "getOneOrNullResult", MIXED);
    REG_METHOD("Doctrine.ORM.Query", "execute", hyp_type_builtin(arena, "array"));
    REG_METHOD("Doctrine.ORM.EntityRepository", "find", MIXED);
    REG_METHOD("Doctrine.ORM.EntityRepository", "findAll", hyp_type_builtin(arena, "array"));
    REG_METHOD("Doctrine.ORM.EntityRepository", "findBy", hyp_type_builtin(arena, "array"));
    ...
    REG_METHOD("Twig.Environment", "render", hyp_type_builtin(arena, "string"));
    REG_METHOD("Twig.Environment", "load",
               hyp_type_named(arena, "Twig.TemplateWrapper"));
    REG_METHOD("Twig.Environment", "createTemplate",
               hyp_type_named(arena, "Twig.TemplateWrapper"));
    REG_METHOD("Twig.TemplateWrapper", "render", hyp_type_builtin(arena, "string"));
    REG_METHOD("Twig.TemplateWrapper", "renderBlock", hyp_type_builtin(arena, "string"));
    ...
    REG_METHOD("Symfony.Contracts.Cache.CacheInterface", "delete", hyp_type_builtin(arena, "bool"));
    REG_METHOD("Symfony.Contracts.Cache.ItemInterface", "set",
               hyp_type_named(arena, "Symfony.Contracts.Cache.ItemInterface"));
    ...
    REG_METHOD("Psr.Cache.CacheItemPoolInterface", "getItem",
               hyp_type_named(arena, "Psr.Cache.CacheItemInterface"));
               ...
               hyp_type_builtin(arena, "void"));
    {
        ...
        const HYPType *self = hyp_type_named(arena, "Symfony.Component.Mime.Email");
    ...
    REG_METHOD("Illuminate.Http.Request", "all", hyp_type_builtin(arena, "array"));
    REG_METHOD("Illuminate.Http.Request", "user", MIXED);
    REG_METHOD("Illuminate.Http.Request", "validate", hyp_type_builtin(arena, "array"));
    REG_METHOD("Illuminate.Http.Response", "header",
               hyp_type_named(arena, "Illuminate.Http.Response"));
    REG_METHOD("Illuminate.Http.Response", "withHeaders",
               hyp_type_named(arena, "Illuminate.Http.Response"));
    REG_METHOD("Illuminate.Http.JsonResponse", "header",
               hyp_type_named(arena, "Illuminate.Http.JsonResponse"));
    ...
    REG_METHOD("Illuminate.Contracts.Auth.Guard", "user",
               hyp_type_named(arena, "Illuminate.Contracts.Auth.Authenticatable"));
    REG_METHOD("Illuminate.Contracts.Auth.Guard", "check", hyp_type_builtin(arena, "bool"));
    ...
    REG_METHOD("Illuminate.Contracts.Session.Session", "put", hyp_type_builtin(arena, "void"));
    REG_METHOD("Illuminate.Contracts.Session.Session", "has", hyp_type_builtin(arena, "bool"));
    REG_METHOD("Illuminate.Contracts.Session.Session", "flash", hyp_type_builtin(arena, "void"));

    REG_TYPE("Illuminate.View.View", "View", false, session_parents);
    REG_METHOD("Illuminate.View.View", "render", hyp_type_builtin(arena, "string"));
    REG_METHOD("Illuminate.View.View", "with",
               hyp_type_named(arena, "Illuminate.View.View"));
    ...
    REG_METHOD("React.Promise.PromiseInterface", "then",
               hyp_type_named(arena, "React.Promise.PromiseInterface"));
    ...
    REG_METHOD("GuzzleHttp.Promise.PromiseInterface", "then",
               hyp_type_named(arena, "GuzzleHttp.Promise.PromiseInterface"));
    ...
    REG_METHOD("Monolog.Logger", "pushHandler",
               hyp_type_named(arena, "Monolog.Logger"));
    ...
    REG_METHOD("ReflectionClass", "getName", hyp_type_builtin(arena, "string"));
    REG_METHOD("ReflectionClass", "getMethods", hyp_type_builtin(arena, "array"));
    REG_METHOD("ReflectionClass", "getMethod",
               hyp_type_named(arena, "ReflectionMethod"));
    ...
    REG_METHOD("ReflectionMethod", "getName", hyp_type_builtin(arena, "string"));
    REG_METHOD("ReflectionProperty", "getValue", MIXED);
    REG_METHOD("ReflectionProperty", "setValue", hyp_type_builtin(arena, "void"));
}
