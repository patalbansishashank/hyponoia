#ifndef HYP_LSP_C_LSP_H
#define HYP_LSP_C_LSP_H

#include "type_rep.h"
#include "scope.h"
#include "type_registry.h"
#include "../hyp.h"
#include "go_lsp.h" // for HYPLSPDef, HYPResolvedCallArray
...
typedef struct {
    ...
    HYPSourceOrigin source_origin; // source buffer represented by emitted occurrence spans
...
void hyp_c_stdlib_register(HYPTypeRegistry *reg, HYPArena *arena);
