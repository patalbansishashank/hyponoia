#!/usr/bin/env bash
# vendor-grammar.sh: Vendor a single tree-sitter grammar into internal/hyp/vendored/grammars/<name>/
...
GRAMMAR_DIR="$PROJECT_DIR/internal/hyp/vendored/grammars/$NAME"
TMPDIR="$(mktemp -d)"
