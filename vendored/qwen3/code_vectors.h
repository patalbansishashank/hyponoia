/* Qwen3-Embedding-0.6B (Qwen/Qwen3-Embedding-0.6B) token embeddings.
 * 40928 tokens x 768d int8-quantized unit vectors.
 * Distilled from 0.6B model via full inference on filtered vocabulary.
 ...
 * License: Apache 2.0
 */
#ifndef HYP_QWEN3_VECTORS_H
#define HYP_QWEN3_VECTORS_H

#include <stdint.h>

#define PRETRAINED_TOKEN_COUNT 40928
