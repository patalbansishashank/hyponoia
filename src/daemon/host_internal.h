 ...
 */
#ifndef HYP_DAEMON_HOST_INTERNAL_H
#define HYP_DAEMON_HOST_INTERNAL_H
...
typedef bool (*hyp_daemon_host_cleanup_release_for_test_fn)(void *context);
...
bool hyp_daemon_host_state_prepare_for_test(const struct hyp_daemon_ipc_endpoint *endpoint);
...
} hyp_daemon_host_http_reconcile_test_result_t;
...
} hyp_daemon_host_http_free_refusal_test_result_t;
...
#endif /* HYP_DAEMON_HOST_INTERNAL_H */
