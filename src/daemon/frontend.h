 ...
 */
#ifndef HYP_DAEMON_FRONTEND_H
#define HYP_DAEMON_FRONTEND_H
...
typedef struct hyp_daemon_maintenance_monitor hyp_daemon_maintenance_monitor_t;
...
typedef bool (*hyp_daemon_maintenance_cancel_fn)(void *context);
