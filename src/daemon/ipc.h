/*
 * ipc.h — Authenticated local transport for the HYP daemon.
 *
 ...
 */
#ifndef HYP_DAEMON_IPC_H
#define HYP_DAEMON_IPC_H
...
typedef struct hyp_daemon_ipc_endpoint hyp_daemon_ipc_endpoint_t;
typedef struct hyp_daemon_ipc_listener hyp_daemon_ipc_listener_t;
typedef struct hyp_daemon_ipc_connection hyp_daemon_ipc_connection_t;
typedef struct hyp_daemon_ipc_startup_lock hyp_daemon_ipc_startup_lock_t;
typedef struct hyp_daemon_ipc_local_transition hyp_daemon_ipc_local_transition_t;
typedef struct hyp_daemon_ipc_participant_guard hyp_daemon_ipc_participant_guard_t;
typedef struct hyp_daemon_ipc_lifetime_reservation hyp_daemon_ipc_lifetime_reservation_t;

/* A receive wait with no wall-clock expiry. The wait remains interruptible by
 * peer EOF and hyp_daemon_ipc_connection_interrupt(). This is intentionally a
 ...
 * arriving. */
#define HYP_DAEMON_IPC_WAIT_FOREVER UINT32_MAX
 ...
 * receive_frame also accepts HYP_DAEMON_IPC_WAIT_FOREVER. */
...
int hyp_daemon_ipc_local_transition_try_acquire(const hyp_daemon_ipc_endpoint_t *endpoint,
...
int hyp_daemon_ipc_local_transition_lifetime_probe(
    const hyp_daemon_ipc_endpoint_t *endpoint, const hyp_daemon_ipc_local_transition_t *transition);
