 ...
 */
#ifndef HYP_DAEMON_APPLICATION_INTERNAL_H
#define HYP_DAEMON_APPLICATION_INTERNAL_H

#include "daemon/application.h"
#include "mcp/mcp.h" /* hyp_jsonrpc_request_t */
...
bool hyp_daemon_application_session_retains_store_for_test(
    const hyp_daemon_runtime_application_session_t *session);
...
#endif /* HYP_DAEMON_APPLICATION_INTERNAL_H */
