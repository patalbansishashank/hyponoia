 ...
 */
#ifndef HYP_GRAPH_BUFFER_H
#define HYP_GRAPH_BUFFER_H
 ...
 * If id_source is NULL, behaves like hyp_gbuf_new(). */
...
typedef void (*hyp_gbuf_node_visitor_fn)(const hyp_gbuf_node_t *node, void *userdata);
void hyp_gbuf_foreach_node(const hyp_gbuf_t *gb, hyp_gbuf_node_visitor_fn fn, void *userdata);

/* Iterate all edges. */
typedef void (*hyp_gbuf_edge_visitor_fn)(const hyp_gbuf_edge_t *edge, void *userdata);
 ...
 * Vectors are carried through to hyp_write_db during the dump phase. */
