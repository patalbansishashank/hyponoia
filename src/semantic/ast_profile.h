 ...
 */
#ifndef HYP_AST_PROFILE_H
#define HYP_AST_PROFILE_H
 ...
 * buf must be at least HYP_AST_PROFILE_BUF bytes. */
enum { HYP_AST_PROFILE_BUF = 200 };
 ...
 * out must have HYP_AST_PROFILE_DIMS elements. */
void hyp_ast_profile_to_vector(const hyp_ast_profile_t *p, float *out);

#endif /* HYP_AST_PROFILE_H */
