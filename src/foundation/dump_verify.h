 ...
 */
bool hyp_dump_verify_is_degraded(int committed_nodes, int persisted_nodes, double ratio,
                                 int min_floor);

/** Read HYP_DUMP_VERIFY_MIN_RATIO (0..1); invalid/unset -> default 0.5. Set 0 to disable. */
double hyp_dump_verify_min_ratio(void);

#endif /* HYP_DUMP_VERIFY_H */
