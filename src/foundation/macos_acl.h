...
#ifndef HYP_FOUNDATION_MACOS_ACL_H
#define HYP_FOUNDATION_MACOS_ACL_H
...
bool hyp_macos_extended_acl_fd_is_empty(int fd);
...
bool hyp_macos_extended_acl_fd_is_deny_only(int fd);
...
bool hyp_macos_extended_acl_fd_clear(int fd);
