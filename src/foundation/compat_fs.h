 ...
 */
#ifndef HYP_COMPAT_FS_H
#define HYP_COMPAT_FS_H
...
#define HYP_DIRENT_NAME_MAX 1024

typedef struct hyp_dir hyp_dir_t;

typedef struct {
    char name[HYP_DIRENT_NAME_MAX];
    bool is_dir;
 ...
 * valid until the next hyp_readdir call on the same handle. */
