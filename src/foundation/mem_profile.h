 ...
 *
 * Off unless HYP_MEM_PROFILE=1. All tables are fixed-capacity and allocated
 ...
 */
#ifndef HYP_MEM_PROFILE_H
#define HYP_MEM_PROFILE_H

#include <stdbool.h>
#include <stddef.h>

/* Gate: HYP_MEM_PROFILE=1. Read once, cached. */
bool hyp_mem_profile_enabled(void);

/* Minimum allocation size recorded, from HYP_MEM_PROFILE_MIN (bytes). */
