 ...
 */
#ifndef HYP_LOCK_REGISTRY_H
#define HYP_LOCK_REGISTRY_H
...
#define HYP_LOCK_REGISTRY_NAME_CAP 80U

typedef struct hyp_lock_registry hyp_lock_registry_t;
typedef struct hyp_lock_lease hyp_lock_lease_t;
typedef atomic_bool hyp_lock_cancel_token_t;
...
/* deadline_ms is an absolute hyp_now_ms() deadline; UINT64_MAX means no
