...
#define AGENT_ENTRY_KEY "hyponoia"
#define AGENT_MAX_CONFIG_BYTES (8U * 1024U * 1024U)
#define AGENT_JSON_MAX_DEPTH 64U

static int agent_install_callback(hyp_agent_client_id_t id, const char *config_path,
                                  const char *binary_path);
static int agent_remove_callback(hyp_agent_client_id_t id, const char *config_path,
                                 const char *binary_path);

static const hyp_agent_client_profile_t agent_profiles[HYP_AGENT_CLIENT_COUNT] = {
    {HYP_AGENT_CLIENT_QODER, "qoder", "Qoder CLI", HYP_AGENT_STABLE,
     HYP_AGENT_CAP_MCP | HYP_AGENT_CAP_SKILL | HYP_AGENT_CAP_AGENT | HYP_AGENT_CAP_HOOK, "qodercli",
     agent_install_callback, agent_remove_callback},
    {HYP_AGENT_CLIENT_KIMI, "kimi", "Kimi Code CLI", HYP_AGENT_STABLE,
    ...
    {HYP_AGENT_CLIENT_GITLAB_DUO, "gitlab-duo", "GitLab Duo CLI", HYP_AGENT_STABLE,
     HYP_AGENT_CAP_MCP | HYP_AGENT_CAP_HOOK, "duo", agent_install_callback, agent_remove_callback},
    {HYP_AGENT_CLIENT_ROVO_DEV, "rovo-dev", "Rovo Dev CLI", HYP_AGENT_STABLE,
    ...
    {HYP_AGENT_CLIENT_AMP, "amp", "Amp", HYP_AGENT_STABLE,
     HYP_AGENT_CAP_MCP | HYP_AGENT_CAP_INSTRUCTIONS | HYP_AGENT_CAP_SKILL, "amp",
     agent_install_callback, agent_remove_callback},
    {HYP_AGENT_CLIENT_DEVIN, "devin", "Devin CLI / Local", HYP_AGENT_STABLE,
     HYP_AGENT_CAP_MCP | HYP_AGENT_CAP_INSTRUCTIONS | HYP_AGENT_CAP_SKILL | HYP_AGENT_CAP_HOOK,
     "devin", agent_install_callback, agent_remove_callback},
    {HYP_AGENT_CLIENT_TABNINE, "tabnine", "Tabnine", HYP_AGENT_STABLE, HYP_AGENT_CAP_MCP, "tabnine",
     agent_install_callback, agent_remove_callback},
    {HYP_AGENT_CLIENT_CONTINUE, "continue", "Continue / cn", HYP_AGENT_CONDITIONAL,
     HYP_AGENT_CAP_MCP, "cn", agent_install_callback, agent_remove_callback},
    {HYP_AGENT_CLIENT_VISUAL_STUDIO, "visual-studio", "Visual Studio", HYP_AGENT_CONDITIONAL,
     HYP_AGENT_CAP_MCP, "devenv", agent_install_callback, agent_remove_callback},
    {HYP_AGENT_CLIENT_TRAE, "trae", "TRAE", HYP_AGENT_CONDITIONAL, HYP_AGENT_CAP_MCP, NULL,
     agent_install_callback, agent_remove_callback},
    {HYP_AGENT_CLIENT_ROO_CODE, "roo-code", "Roo Code", HYP_AGENT_CONDITIONAL, HYP_AGENT_CAP_MCP,
     NULL, agent_install_callback, agent_remove_callback},
    {HYP_AGENT_CLIENT_AMAZON_Q, "amazon-q", "Amazon Q Developer IDE", HYP_AGENT_STABLE,
     HYP_AGENT_CAP_MCP, NULL, agent_install_callback, agent_remove_callback},
    {HYP_AGENT_CLIENT_CODEBUDDY, "codebuddy", "CodeBuddy Code CLI", HYP_AGENT_STABLE,
     HYP_AGENT_CAP_MCP | HYP_AGENT_CAP_INSTRUCTIONS | HYP_AGENT_CAP_SKILL | HYP_AGENT_CAP_AGENT,
     "codebuddy", agent_install_callback, agent_remove_callback},
    {HYP_AGENT_CLIENT_IBM_BOB_IDE, "ibm-bob-ide", "IBM Bob IDE", HYP_AGENT_CONDITIONAL,
     HYP_AGENT_CAP_MCP | HYP_AGENT_CAP_INSTRUCTIONS | HYP_AGENT_CAP_SKILL, NULL,
     agent_install_callback, agent_remove_callback},
    {HYP_AGENT_CLIENT_IBM_BOB_SHELL, "ibm-bob-shell", "IBM Bob Shell", HYP_AGENT_STABLE,
     HYP_AGENT_CAP_MCP | HYP_AGENT_CAP_INSTRUCTIONS, "bob", agent_install_callback,
     agent_remove_callback},
    {HYP_AGENT_CLIENT_POCHI, "pochi", "Pochi", HYP_AGENT_STABLE,
     HYP_AGENT_CAP_MCP | HYP_AGENT_CAP_INSTRUCTIONS | HYP_AGENT_CAP_SKILL | HYP_AGENT_CAP_AGENT,
     "pochi", agent_install_callback, agent_remove_callback},
    {HYP_AGENT_CLIENT_PI, "pi", "Pi", HYP_AGENT_STABLE,
     HYP_AGENT_CAP_INSTRUCTIONS | HYP_AGENT_CAP_SKILL, "pi", NULL, NULL},
    {HYP_AGENT_CLIENT_SOURCEGRAPH_CODY, "sourcegraph-cody", "Sourcegraph Cody", HYP_AGENT_OPT_IN,
     HYP_AGENT_CAP_MCP, NULL, agent_install_callback, agent_remove_callback},
};

size_t hyp_agent_client_count(void) {
    return HYP_AGENT_CLIENT_COUNT;
}

const hyp_agent_client_profile_t *hyp_agent_client_at(size_t index) {
    return index < HYP_AGENT_CLIENT_COUNT ? &agent_profiles[index] : NULL;
}

const hyp_agent_client_profile_t *hyp_agent_client_by_id(hyp_agent_client_id_t id) {
    return (unsigned)id < HYP_AGENT_CLIENT_COUNT ? &agent_profiles[id] : NULL;
}
...
static bool agent_path_exists(const hyp_agent_client_resolve_options_t *options, const char *path) {
    return options->path_exists ? options->path_exists(path, options->probe_context)
                                : hyp_file_exists(path);
}

static bool agent_command_exists(const hyp_agent_client_resolve_options_t *options,
                                 const char *command) {
...
static int agent_rovo_override(const char *config_path, const char *home_dir, bool windows,
                               char *path_out, size_t path_out_size) {
    FILE *file = hyp_fopen(config_path, "rb");
    if (!file) {
        return 1;
    }
...
int hyp_agent_client_resolve_path(hyp_agent_client_id_t id,
    ...
    if (!hyp_agent_client_by_id(id) || !options || !path_out || path_out_size == 0U ||
    ...
    case HYP_AGENT_CLIENT_KIMI:
        return agent_join_path(
            ...
            options->kimi_code_home && options->kimi_code_home[0] ? "mcp.json"
                                                                  : ".kimi-code/mcp.json");
    case HYP_AGENT_CLIENT_GITLAB_DUO:
    ...
    case HYP_AGENT_CLIENT_ROVO_DEV: {
    ...
    case HYP_AGENT_CLIENT_AMP:
        ...
        return agent_join_path(path_out, path_out_size, options->home_dir,
                               ".config/agents/skills/hyponoia/mcp.json");
    case HYP_AGENT_CLIENT_DEVIN:
        if (options->is_windows && options->appdata_dir && options->appdata_dir[0]) {
            return agent_join_path(path_out, path_out_size, options->appdata_dir,
                                   "devin/config.json");
        }
    ...
    case HYP_AGENT_CLIENT_TABNINE:
        return agent_join_path(path_out, path_out_size, options->home_dir,
                               ".tabnine/mcp_servers.json");
    case HYP_AGENT_CLIENT_CONTINUE: {
    ...
    case HYP_AGENT_CLIENT_ROO_CODE:
    ...
    case HYP_AGENT_CLIENT_AMAZON_Q: {
    ...
    case HYP_AGENT_CLIENT_CODEBUDDY: {
...
static int agent_client_marker_path(hyp_agent_client_id_t id,
...
bool hyp_agent_client_detect(hyp_agent_client_id_t id,
                             const hyp_agent_client_resolve_options_t *options) {
    const hyp_agent_client_profile_t *profile = hyp_agent_client_by_id(id);
    if (!profile || !options) {
        return false;
    }
    char path[1024];
    int resolved = hyp_agent_client_resolve_path(id, options, path, sizeof(path));
    if (id == HYP_AGENT_CLIENT_CONTINUE || id == HYP_AGENT_CLIENT_TRAE ||
        id == HYP_AGENT_CLIENT_ROO_CODE || id == HYP_AGENT_CLIENT_SOURCEGRAPH_CODY) {
        return resolved == 0 && agent_path_exists(options, path);
    }
    if (id == HYP_AGENT_CLIENT_VISUAL_STUDIO) {
...
bool hyp_agent_client_cleanup_candidate(hyp_agent_client_id_t id,
                                        const hyp_agent_client_resolve_options_t *options) {
    if (hyp_agent_client_detect(id, options)) {
        return true;
    }
    if (id != HYP_AGENT_CLIENT_VISUAL_STUDIO || !options || !options->is_windows) {
        return false;
    }
    char path[1024];
    return hyp_agent_client_resolve_path(id, options, path, sizeof(path)) == 0 &&
...
static char *agent_json_canonical(hyp_agent_client_id_t id, const char *binary_path) {
    char *escaped = agent_json_escape(binary_path);
    if (!escaped) {
        return NULL;
    }
    const char *extra = "";
    if (id == HYP_AGENT_CLIENT_GITLAB_DUO || id == HYP_AGENT_CLIENT_VISUAL_STUDIO) {
        extra = ", \"type\": \"stdio\"";
    } else if (id == HYP_AGENT_CLIENT_ROVO_DEV) {
...
static const char *agent_json_section(hyp_agent_client_id_t id) {
    if (id == HYP_AGENT_CLIENT_AMP) {
        return NULL;
    }
    if (id == HYP_AGENT_CLIENT_VISUAL_STUDIO) {
        return "servers";
    }
    if (id == HYP_AGENT_CLIENT_SOURCEGRAPH_CODY) {
        return "cody.mcpServers";
    }
    if (id == HYP_AGENT_CLIENT_POCHI) {
        return "mcp";
    }
    return "mcpServers";
}

static int agent_json_edit(hyp_agent_client_id_t id, const char *config_path,
                           const char *binary_path, bool remove) {
    char *canonical = agent_json_canonical(id, binary_path);
    if (!canonical) {
        return HYP_AGENT_EDIT_ERROR;
    }
    char *document = NULL;
    size_t length = 0U;
    int read_result = hyp_json_like_read_document(config_path, &document, &length);
    if (read_result < 0) {
        free(canonical);
        return HYP_AGENT_EDIT_ERROR;
    }
    ...
    if (find_result == 0 && !agent_json_owned(document, entry_start, entry_end, canonical)) {
        free(document);
        free(canonical);
        return HYP_AGENT_EDIT_FOREIGN;
    }
    if ((remove && find_result == 1) || (!remove && find_result == 0)) {
        free(document);
        free(canonical);
        return HYP_AGENT_EDIT_OK;
    }
    const char *section = agent_json_section(id);
    const char *path[1] = {section};
    int edit_result =
        remove
            ? hyp_json_like_remove_entry_if_unchanged(config_path, path, section ? 1U : 0U,
                                                      AGENT_ENTRY_KEY, document, length)
            : hyp_json_like_upsert_entry_if_unchanged(config_path, path, section ? 1U : 0U,
                                                      AGENT_ENTRY_KEY, canonical,
                                                      read_result == 1 ? NULL : document, length);
    free(document);
    free(canonical);
    return edit_result == 0 ? HYP_AGENT_EDIT_OK : HYP_AGENT_EDIT_ERROR;
}
...
static int agent_continue_edit(const char *config_path, const char *binary_path, bool remove) {
    char *document = NULL;
    size_t length = 0U;
    if (hyp_json_like_read_document(config_path, &document, &length) != 0 || !document) {
        free(document);
        return HYP_AGENT_EDIT_NOT_APPLICABLE;
    }
    char *quoted = NULL;
    if (hyp_yaml_encode_double_quoted_scalar(binary_path, &quoted) != 0) {
        free(document);
        return HYP_AGENT_EDIT_ERROR;
    }
    ...
    int result = updated && hyp_text_write_owned_document_if_unchanged(config_path, updated,
                                                                       document, length) == 0
                     ? HYP_AGENT_EDIT_OK
...
static bool agent_json_client(hyp_agent_client_id_t id) {
    switch (id) {
    case HYP_AGENT_CLIENT_QODER:
    case HYP_AGENT_CLIENT_KIMI:
    case HYP_AGENT_CLIENT_GITLAB_DUO:
...
int hyp_agent_client_install_mcp(hyp_agent_client_id_t id, const char *config_path,
    ...
    if (!config_path || config_path[0] == '\0' || !binary_path || binary_path[0] == '\0' ||
        !hyp_agent_client_by_id(id)) {
        return HYP_AGENT_EDIT_ERROR;
    }
    if (id == HYP_AGENT_CLIENT_CONTINUE) {
...
static int agent_install_callback(hyp_agent_client_id_t id, const char *config_path,
                                  const char *binary_path) {
    return hyp_agent_client_install_mcp(id, config_path, binary_path);
}

static int agent_remove_callback(hyp_agent_client_id_t id, const char *config_path,
                                 const char *binary_path) {
    return hyp_agent_client_remove_mcp(id, config_path, binary_path);
}
