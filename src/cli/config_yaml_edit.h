 ...
 */
#ifndef HYP_CONFIG_YAML_EDIT_H
#define HYP_CONFIG_YAML_EDIT_H
 ...
 * "<file_path>.hyp-yaml.lock" regular file, created with mode 0600 and held by
 ...
 * hyp_yaml_encode_double_quoted_scalar(). Full-line comments remain allowed.
 *
 ...
 * return HYP_YAML_IDENTITY_EDIT_FOREIGN. Errors return
 ...
 * hyp_yaml_encode_double_quoted_scalar().
 *
 ...
 * HYP_YAML_IDENTITY_EDIT_FOREIGN. Removal deletes only the exact canonical
 ...
 * concurrency failures return HYP_YAML_IDENTITY_EDIT_ERROR byte-identically. */
enum {
    HYP_YAML_IDENTITY_EDIT_ERROR = -1,
    HYP_YAML_IDENTITY_EDIT_OK = 0,
    HYP_YAML_IDENTITY_EDIT_FOREIGN = 1
};
...
typedef void (*hyp_yaml_precommit_test_hook_t)(const char *file_path, void *context);
