#ifndef HYP_MCP_INTERNAL_H
#define HYP_MCP_INTERNAL_H

#include "mcp/mcp.h"
#include "pipeline/pipeline.h" /* hyp_changed_hunk_t */
#include "store/store.h"       /* hyp_node_t */
...
typedef bool (*hyp_mcp_quarantine_test_hook_fn)(void *context, const char *step);
typedef bool (*hyp_mcp_command_test_hook_fn)(void *context, const char *command);
 ...
 * hyp_mcp_server_new(NULL) semantics remain unchanged; daemon sessions use
...
enum { HYP_MCP_DEFAULT_AUTO_INDEX_LIMIT = 50000 };
